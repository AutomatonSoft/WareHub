...
initialize_local_runtime_env() {
  ...
  local redis_port
  redis_port="$(get_env_or_default "DEV_REDIS_PORT" "8936")"
  ...
  export DEV_REDIS_PORT="$redis_port"
  set_env_if_missing "JV_SOURCE_DB_REDIS_URL" "redis://127.0.0.1:$redis_port/1"
  set_env_if_missing "JV_SOURCE_DB_REDIS_MAX_CONCURRENT_CONNECTIONS" "2"
  set_env_if_missing "JV_SOURCE_DB_REDIS_LOCK_WAIT_SECONDS" "40"
  set_env_if_missing "JV_SOURCE_DB_REDIS_LOCK_TIMEOUT_SECONDS" "120"
