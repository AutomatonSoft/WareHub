...
pub(crate) use handlers_password_reset::{
    confirm_authenticated_password_change, confirm_password_reset,
    request_authenticated_password_change_code, request_password_reset,
};
...
pub(crate) use handlers::{
    ...
    login_user, logout_user, refresh_user, register_user,
};
