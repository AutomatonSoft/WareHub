  ...
  "wh-badge group/badge inline-flex h-6 w-fit shrink-0 items-center justify-center gap-1.5 overflow-hidden rounded-full border border-transparent px-2.5 text-xs font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        success: "wh-badge--success border-transparent bg-[#ECFDF5] text-[#047857]",
        warning: "wh-badge--warning border-transparent bg-[#FFFBEB] text-[#B45309]",
        error: "wh-badge--error border-transparent bg-[#FEF2F2] text-[#DC2626]",
