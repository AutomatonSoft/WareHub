...
router = APIRouter()
_SUPPORTED_GROUPS = {ProductEditorGroupId.HOOD, ProductEditorGroupId.JV, ProductEditorGroupId.XL, ProductEditorGroupId.OTTO, ProductEditorGroupId.KAUFLAND, ProductEditorGroupId.EBAY}
