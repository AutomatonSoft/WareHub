...
class BackendSessionBridgeAllowlistTests(SimpleTestCase):
    ...
    @override_settings(BACKEND_SESSION_BRIDGE_ALLOWED_HOSTS=["localhost", "127.0.0.1"])
    ...
    @override_settings(BACKEND_SESSION_BRIDGE_ALLOWED_HOSTS=["stagewarehub.automatonsoft.de"])
