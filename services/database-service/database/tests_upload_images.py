...
class UploadImagesToFtpTests(SimpleTestCase):
    ...
    def test_xl_upload_returns_open_cart_db_path_and_public_url(self, mock_upload):
        mock_upload.return_value = {
            "db_path": "avatar/xl_xlmoebel_de_20260526000000_abcd1234.jpg",
            "public_url": "https://www.xlmoebel.de/image/avatar/xl_xlmoebel_de_20260526000000_abcd1234.jpg",
        ...
        self.assertEqual(response.data["uploaded_image_urls"], ["avatar/xl_xlmoebel_de_20260526000000_abcd1234.jpg"])
        self.assertEqual(
            response.data["uploaded_image_public_urls"],
            ["https://www.xlmoebel.de/image/avatar/xl_xlmoebel_de_20260526000000_abcd1234.jpg"],
        )
        self.assertEqual(response.data["image"], "avatar/xl_xlmoebel_de_20260526000000_abcd1234.jpg")
        self.assertEqual(
    ...
    def test_xl_site_specific_ftp_uses_site_root_and_site_public_url(self):
        _host, _port, _user, _password, remote_parts, public_base, avatar_dir, *_rest = _ensure_config_for_site_key("XLMOEBEL_DE")

        self.assertEqual(remote_parts, ["image", "avatar"])
        self.assertEqual(public_base, "https://www.xlmoebel.de/image")
        self.assertEqual(avatar_dir, "avatar")
