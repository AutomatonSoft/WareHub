# Generated by Django 5.2.13 on 2026-04-15 10:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('jv_services', '0003_importedproduct_local_save_status_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_family', models.CharField(choices=[('XL', 'XL'), ('JV', 'JV')], db_index=True, max_length=8)),
            ...
            options={
                'db_table': 'xljv_batch_jobs',
                'ordering': ['-created_at'],
            },
        ),
        migrations.CreateModel(
            name='XLJVBatchJobItem',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='jv_services.xljvbatchjob')),
            ],
            options={
                'db_table': 'xljv_batch_job_items',
                'ordering': ['id'],
            },
        ),
    ]
