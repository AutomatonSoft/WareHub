...
$requiredKeysByEnvironment = @{
  stage = @(
    ...
    'AFTERBUY_JV_LOGIN','AFTERBUY_JV_PASS','AFTERBUY_XL_LOGIN','AFTERBUY_XL_PASS','AFTERBUY_JV_LOGIN_URL',
    'AFTERBUY_XL_LOGIN_URL','AFTERBUY_JV_COOKIE_CACHE_FILE','AFTERBUY_XL_COOKIE_CACHE_FILE',
    'BACKEND_UPLOAD_STORAGE_BACKEND','BACKEND_UPLOAD_FTP_HOST','BACKEND_UPLOAD_FTP_USER','BACKEND_UPLOAD_FTP_PASS',
    'BACKEND_UPLOAD_FTP_PORT','BACKEND_UPLOAD_FTP_ROOT_DIR','BACKEND_UPLOAD_FTP_STORAGE_ROOT_DIR',
    'BACKEND_UPLOAD_FTP_AVATAR_DIR','BACKEND_STAGE_UPLOAD_FTP_PUBLIC_BASE_URL'
  )
  prod = @(
    ...
    'AFTERBUY_XL_LOGIN','AFTERBUY_XL_PASS','AFTERBUY_JV_LOGIN_URL','AFTERBUY_XL_LOGIN_URL',
    'AFTERBUY_JV_COOKIE_CACHE_FILE','AFTERBUY_XL_COOKIE_CACHE_FILE','BACKEND_UPLOAD_STORAGE_BACKEND',
    'BACKEND_UPLOAD_FTP_HOST','BACKEND_UPLOAD_FTP_USER','BACKEND_UPLOAD_FTP_PASS','BACKEND_UPLOAD_FTP_PORT',
    'BACKEND_UPLOAD_FTP_ROOT_DIR','BACKEND_UPLOAD_FTP_STORAGE_ROOT_DIR','BACKEND_UPLOAD_FTP_AVATAR_DIR',
