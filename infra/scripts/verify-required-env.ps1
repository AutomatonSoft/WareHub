...
$requiredKeysByEnvironment = @{
  stage = @(
    ...
    'STAGE_MONGO_USER','STAGE_MONGO_PASSWORD','STAGE_MONGO_DATABASE','STAGE_REDIS_PASSWORD',
    ...
    'HOOD_API_BASE_URL','HOOD_LOGIN','HOOD_PASSWORD',
    ...
    'ORCHESTRATOR_HTTP_TIMEOUT_SECONDS','ORCHESTRATOR_DISCOVER_TIMEOUT_SECONDS','ORCHESTRATOR_HTTP_RETRIES','ORCHESTRATOR_IDEMPOTENCY_TTL_SECONDS',
    ...
    'AFTERBUY_CH_PASS','AFTERBUY_JV_PARTNER_TOKEN','AFTERBUY_JV_ACCOUNT_TOKEN',
    'AFTERBUY_XL_PARTNER_TOKEN','AFTERBUY_XL_ACCOUNT_TOKEN','AFTERBUY_CH_PARTNER_TOKEN','AFTERBUY_CH_ACCOUNT_TOKEN',
  ...
  prod = @(
    ...
    'PROD_MONGO_USER','PROD_MONGO_PASSWORD','PROD_MONGO_DATABASE','PROD_REDIS_PASSWORD',
    ...
    'HOOD_API_BASE_URL','HOOD_LOGIN','HOOD_PASSWORD',
    'PROD_BACKEND_SESSION_BRIDGE_ALLOWED_HOSTS','PROD_ORCHESTRATOR_SERVICE_AUTH_TOKEN',
    'PROD_ORCHESTRATOR_SERVICE_ALLOWED_HOSTS','PROD_ORCHESTRATOR_DATABASE_SERVICE_BASE_URL',
    'ORCHESTRATOR_HTTP_TIMEOUT_SECONDS','ORCHESTRATOR_DISCOVER_TIMEOUT_SECONDS','ORCHESTRATOR_HTTP_RETRIES','ORCHESTRATOR_IDEMPOTENCY_TTL_SECONDS',
    'ORCHESTRATOR_SERVICE_NAME','ORCHESTRATOR_LOG_LEVEL','JV_SOURCE_DB_HOST','JV_SOURCE_DB_USER','JV_SOURCE_DB_PASSWORD',
    'JV_SOURCE_DB_NAME','JV_SOURCE_DB_PORT','JV_SOURCE_DB_CONNECT_RETRIES','JV_SOURCE_DB_PUSH_RETRIES',
    'JV_SOURCE_DB_CONNECT_TIMEOUT_SEC','JV_SOURCE_DB_READ_TIMEOUT_SEC','JV_SOURCE_DB_WRITE_TIMEOUT_SEC',
    ...
    'JV_SOURCE_JV_CH_DB_NAME','JV_SOURCE_JV_CH_DB_PORT','JV_SOURCE_JV_CO_UK_DB_HOST','JV_SOURCE_JV_CO_UK_DB_USER',
    'JV_SOURCE_JV_CO_UK_DB_PASSWORD','JV_SOURCE_JV_CO_UK_DB_NAME','JV_SOURCE_JV_CO_UK_DB_PORT',
    'AFTERBUY_JV_LOGIN','AFTERBUY_JV_PASS','AFTERBUY_JV_PARTNER_TOKEN','AFTERBUY_JV_ACCOUNT_TOKEN',
    'AFTERBUY_XL_LOGIN','AFTERBUY_XL_PASS','AFTERBUY_XL_PARTNER_TOKEN','AFTERBUY_XL_ACCOUNT_TOKEN',
    'AFTERBUY_CH_LOGIN','AFTERBUY_CH_PASS','AFTERBUY_CH_PARTNER_TOKEN','AFTERBUY_CH_ACCOUNT_TOKEN',
    'AFTERBUY_JV_LOGIN_URL','AFTERBUY_XL_LOGIN_URL','AFTERBUY_CH_LOGIN_URL',
    'AFTERBUY_JV_COOKIE_CACHE_FILE','AFTERBUY_XL_COOKIE_CACHE_FILE','AFTERBUY_CH_COOKIE_CACHE_FILE',
...
$optionalPresentKeysByEnvironment = @{
  stage = @(
    ...
    'NEXT_PUBLIC_SENTRY_DSN','SERVICES_STAGE_SENTRY_DSN','SERVICES_STAGE_SENTRY_TRACES_SAMPLE_RATE',
    'ORCHESTRATOR_STAGE_SENTRY_DSN','ORCHESTRATOR_STAGE_SENTRY_TRACES_SAMPLE_RATE',
    'SERVICES_LOG_LEVEL','SERVICES_SERVICE_NAME'
  )
  prod = @(
    ...
    'NEXT_PUBLIC_SENTRY_DSN','SERVICES_PROD_SENTRY_DSN','SERVICES_PROD_SENTRY_TRACES_SAMPLE_RATE',
    'ORCHESTRATOR_PROD_SENTRY_DSN','ORCHESTRATOR_PROD_SENTRY_TRACES_SAMPLE_RATE',
    'SERVICES_LOG_LEVEL','SERVICES_SERVICE_NAME'
  )
}
...
$stageTelegramInternalRuntimeKeys = @('STAGE_TELEGRAM_SERVICES_BASE_URL','STAGE_TELEGRAM_ORCHESTRATOR_BASE_URL')
$prodTelegramInternalRuntimeKeys = @(
  'PROD_TELEGRAM_SERVICES_BASE_URL',
  'PROD_TELEGRAM_ORCHESTRATOR_BASE_URL'
)

$optionalEmptyKeysByEnvironment = @{
  stage = @('MOBILE_STAGE_APP_VERSION','MOBILE_STAGE_APK_URL','JV_SOURCE_JV_DE_DB_PREFIX','JV_SOURCE_JV_AT_DB_PREFIX','JV_SOURCE_JV_CH_DB_PREFIX','JV_SOURCE_JV_CO_UK_DB_PREFIX') + $jvPerSiteFtpKeys + $openAiTranslationKeys + $servicesOptionalRuntimeKeys + $stageTelegramInternalRuntimeKeys
  prod = @('MOBILE_STAGE_APP_VERSION','MOBILE_STAGE_APK_URL','MOBILE_PROD_APP_VERSION','MOBILE_PROD_APK_URL','JV_SOURCE_JV_DE_DB_PREFIX','JV_SOURCE_JV_AT_DB_PREFIX','JV_SOURCE_JV_CH_DB_PREFIX','JV_SOURCE_JV_CO_UK_DB_PREFIX') + $jvPerSiteFtpKeys + $openAiTranslationKeys + $servicesOptionalRuntimeKeys + $prodTelegramInternalRuntimeKeys
}

$sampleRateKeysByEnvironment = @{
  stage = @('BACKEND_STAGE_SENTRY_TRACES_SAMPLE_RATE','FRONTEND_STAGE_SENTRY_TRACES_SAMPLE_RATE','FRONTEND_STAGE_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE','FRONTEND_STAGE_SENTRY_REPLAYS_SESSION_SAMPLE_RATE','SERVICES_STAGE_SENTRY_TRACES_SAMPLE_RATE','ORCHESTRATOR_STAGE_SENTRY_TRACES_SAMPLE_RATE')
  prod = @('BACKEND_PROD_SENTRY_TRACES_SAMPLE_RATE','FRONTEND_PROD_SENTRY_TRACES_SAMPLE_RATE','FRONTEND_PROD_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE','FRONTEND_PROD_SENTRY_REPLAYS_SESSION_SAMPLE_RATE','SERVICES_PROD_SENTRY_TRACES_SAMPLE_RATE','ORCHESTRATOR_PROD_SENTRY_TRACES_SAMPLE_RATE')
}
...
$portKeysByEnvironment = @{
  ...
  prod = @('PROD_GATEWAY_PORT','PROD_SMTP_PORT','BACKEND_UPLOAD_FTP_PORT','JV_SOURCE_DB_PORT','JV_SOURCE_JV_DE_DB_PORT','JV_SOURCE_JV_AT_DB_PORT','JV_SOURCE_JV_CH_DB_PORT','JV_SOURCE_JV_CO_UK_DB_PORT')
}
...
$integerKeysByEnvironment = @{
  stage = @('STAGE_PASSWORD_RESET_CODE_TTL_MINUTES','ORCHESTRATOR_HTTP_TIMEOUT_SECONDS','ORCHESTRATOR_DISCOVER_TIMEOUT_SECONDS','ORCHESTRATOR_HTTP_RETRIES','ORCHESTRATOR_IDEMPOTENCY_TTL_SECONDS','JV_SOURCE_DB_CONNECT_RETRIES','JV_SOURCE_DB_PUSH_RETRIES','JV_SOURCE_DB_CONNECT_TIMEOUT_SEC','JV_SOURCE_DB_READ_TIMEOUT_SEC','JV_SOURCE_DB_WRITE_TIMEOUT_SEC','JV_SOURCE_DB_CONNECT_RETRY_SLEEP_SEC','JV_SOURCE_DB_PUSH_RETRY_SLEEP_SEC')
  prod = @('PROD_PASSWORD_RESET_CODE_TTL_MINUTES','ORCHESTRATOR_HTTP_TIMEOUT_SECONDS','ORCHESTRATOR_DISCOVER_TIMEOUT_SECONDS','ORCHESTRATOR_HTTP_RETRIES','ORCHESTRATOR_IDEMPOTENCY_TTL_SECONDS','JV_SOURCE_DB_CONNECT_RETRIES','JV_SOURCE_DB_PUSH_RETRIES','JV_SOURCE_DB_CONNECT_TIMEOUT_SEC','JV_SOURCE_DB_READ_TIMEOUT_SEC','JV_SOURCE_DB_WRITE_TIMEOUT_SEC','JV_SOURCE_DB_CONNECT_RETRY_SLEEP_SEC','JV_SOURCE_DB_PUSH_RETRY_SLEEP_SEC')
}
...
$containsRequirementsByEnvironment = @{
  ...
  prod = @(
    ...
    @{ Key = 'PROD_ORCHESTRATOR_SERVICE_ALLOWED_HOSTS'; RequiredValue = 'services' }
  )
}
