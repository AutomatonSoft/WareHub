...
function New-ValidStageEnvLines {
  return @(
    ...
    'STAGE_MONGO_USER=warehub_stage',
    'STAGE_MONGO_PASSWORD=placeholder-secret',
    'STAGE_MONGO_DATABASE=warehub',
    'STAGE_REDIS_PASSWORD=placeholder-secret',
    ...
    'HOOD_API_BASE_URL=https://hood.example.test',
    'HOOD_LOGIN=placeholder-user',
    'HOOD_PASSWORD=placeholder-secret',
    ...
    'ORCHESTRATOR_DISCOVER_TIMEOUT_SECONDS=15',
    ...
    'STAGE_TELEGRAM_SERVICES_BASE_URL=http://services:8000',
    'STAGE_TELEGRAM_ORCHESTRATOR_BASE_URL=http://orchestrator:8011',
...
function New-TemplateStageEnvLines {
  return @(
    ...
    'STAGE_MONGO_USER=**SET_OUTSIDE_GIT**',
    'STAGE_MONGO_PASSWORD=**SET_OUTSIDE_GIT**',
    'STAGE_MONGO_DATABASE=warehub',
    'STAGE_REDIS_PASSWORD=**SET_OUTSIDE_GIT**',
    ...
    'HOOD_API_BASE_URL=**SET_OUTSIDE_GIT**',
    'HOOD_LOGIN=**SET_OUTSIDE_GIT**',
    'HOOD_PASSWORD=**SET_OUTSIDE_GIT**',
    'STAGE_RUN_MIGRATIONS_ON_STARTUP=false',
    'STAGE_SERVICES_ALLOWED_HOSTS=stage.example.test,services,localhost,127.0.0.1',
    'STAGE_BACKEND_AUTH_BASE_URL=http://backend:8932/api/v1',
    'STAGE_BACKEND_SESSION_BRIDGE_ALLOWED_HOSTS=stage.example.test,localhost,127.0.0.1',
    ...
    'AFTERBUY_JV_PARTNER_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_JV_ACCOUNT_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_XL_LOGIN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_XL_PASS=**SET_OUTSIDE_GIT**',
    'AFTERBUY_XL_PARTNER_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_XL_ACCOUNT_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_CH_LOGIN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_CH_PASS=**SET_OUTSIDE_GIT**',
    'AFTERBUY_CH_PARTNER_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_CH_ACCOUNT_TOKEN=**SET_OUTSIDE_GIT**',
    'AFTERBUY_JV_LOGIN_URL=https://example.test/jv/login',
    'AFTERBUY_XL_LOGIN_URL=https://example.test/xl/login',
    'AFTERBUY_CH_LOGIN_URL=https://example.test/ch/login',
    'AFTERBUY_JV_COOKIE_CACHE_FILE=/tmp/afterbuy-jv-cookie-cache.json',
