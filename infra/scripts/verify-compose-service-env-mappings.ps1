...
$expectedMappingsByEnvironment = @{
  stage = @{
    backend = @{
      ...
      UPLOAD_FTP_ROOT_DIR = 'BACKEND_STAGE_UPLOAD_FTP_ROOT_DIR'
      UPLOAD_FTP_STORAGE_ROOT_DIR = 'BACKEND_STAGE_UPLOAD_FTP_STORAGE_ROOT_DIR'
      UPLOAD_FTP_AVATAR_DIR = 'BACKEND_STAGE_UPLOAD_FTP_AVATAR_DIR'
      UPLOAD_FTP_IMAGE_DIR = 'BACKEND_STAGE_UPLOAD_FTP_IMAGE_DIR'
  ...
  prod = @{
    backend = @{
      ...
      UPLOAD_FTP_PASS = 'BACKEND_UPLOAD_FTP_PASS'
      UPLOAD_FTP_PORT = 'BACKEND_UPLOAD_FTP_PORT'
      UPLOAD_FTP_ROOT_DIR = 'BACKEND_PROD_UPLOAD_FTP_ROOT_DIR'
      UPLOAD_FTP_STORAGE_ROOT_DIR = 'BACKEND_PROD_UPLOAD_FTP_STORAGE_ROOT_DIR'
      UPLOAD_FTP_AVATAR_DIR = 'BACKEND_PROD_UPLOAD_FTP_AVATAR_DIR'
      UPLOAD_FTP_IMAGE_DIR = 'BACKEND_PROD_UPLOAD_FTP_IMAGE_DIR'
